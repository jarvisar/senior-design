...
This project is built using [Angular 14](https://angular.io/) and is a Progressive Web App (PWA) that can also be installed on your device like a regular app. To install, visit the [website](http://jarvisar.github.io/senior-design) on a device with a modern browser and look for the "install" button in your browser's menu or address bar.
